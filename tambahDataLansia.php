...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4" style="color: #198754;">Tambah Data Lansia</h1>
        <form action="proses.php" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" name="gulaDarah" id="gulaDarah" class="form-control" required>
            </div>
            <div class="form-group mb-3">
                <label for="diastolik" class="form-label">Tekanan Darah Diastolik</label>
                <input type="number" name="diastolik" id="diastolik" class="form-control" required>
            </div>
            <div class="form-group mb-3">
                <label for="sistolik" class="form-label">Tekanan Darah Sistolik</label>
                <input type="number" name="sistolik" id="sistolik" class="form-control" required>
            </div>
            <div class="form-group mb-3">
            ...
            <button type="submit" class="btn btn-success w-100" name="submitTambahLansia">Tambah</button>
        </form>
    </div>
