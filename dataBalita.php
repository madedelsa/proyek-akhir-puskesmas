<?php
    ...
    $queryData = mysqli_query($conn, "SELECT * FROM catatan_balita");
    $i = 1;
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center mb-4">Data Kesehatan Balita</h1>

        <?php if(isset($_GET["hapusSukses"])) : ?>
            <p class="text-success text-center">Berhasil menghapus data</p>
        <?php endif; ?>
        <?php if(isset($_GET["editSuccess"])) : ?>
            <p class="text-success text-center">Berhasil mengubah data</p>
        <?php endif; ?>
        <?php if(isset($_GET["insertBalitaSuccess"])) : ?>
            <p class="text-success text-center">Berhasil menambah data</p>
        <?php endif; ?>

        <div class="d-flex justify-content-end mb-3">
            <a href="tambahDataBalita.php" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Tambah Data</a>
        </div>
            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $result["tinggi_badan"] ?></td>
                        <td><?= $result["catatan"] ?></td>
                        <td class="d-flex gap-3 justify-content-center">
                            <a href="editBalita.php?editDataBalita=<?= $result["id"] ?>" class="btn btn-warning btn-sm">
                                <i class="bi bi-pencil-square"></i> Edit
                            </a>
                            <a href="proses.php?deleteDataBalita=<?= $result["id"] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">
